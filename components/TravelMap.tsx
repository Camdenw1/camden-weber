...
const locations: { name: string; lat: number; lng: number; type: LocationType }[] = [
  ...
  { name: 'Barcelona, Spain', lat: 41.3874, lng: 2.1686, type: 'regular' },
  { name: 'Budapest, Hungary', lat: 47.4979, lng: 19.0402, type: 'regular' },
  { name: 'Dubrovnik, Croatia', lat: 42.6507, lng: 18.0944, type: 'regular' },
  { name: 'Split, Croatia', lat: 43.5081, lng: 16.4402, type: 'regular' },
  { name: 'Plitvice Lakes National Park, Croatia', lat: 44.8654, lng: 15.5820, type: 'park' },
  { name: 'Boston, MA', lat: 42.3601, lng: -71.0589, type: 'regular' },
  { name: 'Fort Collins, CO', lat: 40.5853, lng: -105.0844, type: 'regular' },
  { name: 'Washington, DC', lat: 38.9072, lng: -77.0369, type: 'regular' },
